...
class Userbot(Client):
    def __init__(self):
        self.one = Client(
            ...
            no_updates=False,
            plugins=dict(root="GOKUMUSIC.plugins.user"),
        )
    ...
    async def start(self):
        ...
        if config.STRING2:
            ...
            try:
                await self.two.join_chat("LOVING_SOCIETY")
                await self.two.join_chat("goku_groupz")
                await self.two.join_chat("channelz_k")
                await self.two.join_chat("Zindagi_hai_tere_na")
            except:
                pass
            assistants.append(2)
        ...
        if config.STRING3:
            ...
            try:
                await self.three.join_chat("LOVING_SOCIETY")
                await self.three.join_chat("goku_groupz")
                await self.three.join_chat("channelz_k")
                await self.three.join_chat("Zindagi_hai_tere_na")
            except:
                pass
            assistants.append(3)
        ...
        if config.STRING4:
            ...
            try:
                ...
                await self.four.join_chat("Zindagi_hai_tere_na")
            except:
                pass
            assistants.append(4)
        ...
        if config.STRING5:
            ...
            try:
                await self.five.join_chat("LOVING_SOCIETY")
                await self.five.join_chat("goku_groupz")
                await self.five.join_chat("channelz_k")
                await self.five.join_chat("Zindagi_hai_tere_na")
            except:
                pass
            assistants.append(5)
