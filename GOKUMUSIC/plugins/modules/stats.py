...
from GOKUMUSIC.music import SUDOERS, mongodb
...
from GOKUMUSIC.utils.inline.stats import back_stats_buttons, stats_buttons
...
async def overall_stats(client, CallbackQuery, _):
    ...
    med = InputMediaPhoto(media=config.START_IMG_URL, caption=text)
    try:
        await CallbackQuery.edit_message_media(media=med, reply_markup=upl)
    except MessageIdInvalid:
        await CallbackQuery.message.reply_photo(
            photo=config.START_IMG_URL, caption=text, reply_markup=upl
        )
